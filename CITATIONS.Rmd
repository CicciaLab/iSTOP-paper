...
knitr::opts_chunk$set(echo = FALSE, results = 'asis', warnings = F)
```
...
print(citation('gridExtra'), style = 'html')
print(citation('gtable'), style = 'html')
print(citation('cowplot'), style = 'html')
```
